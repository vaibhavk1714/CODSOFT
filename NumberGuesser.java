...
public class NumberGuesser {
	...
	public static void startGame() {
		// Initialize necessary variables such as score and a boolean to track if user
		// wants to play again
		...
		while (playAgain) {
			...
			while (attempts != 0) {
				...
				// If the guess is correct we increment the score else we assist the user with
				// some hints
